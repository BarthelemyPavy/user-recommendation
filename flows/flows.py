...
from metaflow import FlowSpec, step, Parameter, metadata, get_metadata
from user_recommendation import logger

metadata("local@" + str(Path(__file__).parent / "metaflow"))
...
class GenerateTrainTestValFlow(FlowSpec):
    ...
    def warm_start_split(self) -> None:
        ...
        self.next(self.create_datasets_object)

    @step
    def create_datasets_object(self) -> None:
    ...
    @step
    def end(self) -> None:
        """End of the flow, serialize datasets"""
        pass
